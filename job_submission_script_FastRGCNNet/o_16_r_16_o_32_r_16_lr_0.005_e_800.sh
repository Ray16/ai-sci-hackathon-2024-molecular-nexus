...
python 1_hyperparameter_tuning_FastRGCNNet.py --out_channels_l1 16 --num_relations_l1 16 --out_channels_l2 32 --num_relations_l2 16 --learning_rate 0.005 --max_epoch 800